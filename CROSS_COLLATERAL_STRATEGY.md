...
**Classification:** 🟠 STRATEGIC — Maximum Facility Architecture

---

## The Power of Combining Gems + Bonds
...
## Full Collateral Architecture

```
    ┌──────────────────────────────────────────────────────────────────────┐
    │                OPTKAS1 COLLATERAL PORTFOLIO                          │
    │                                                                      │
    │   ┌──────────────────────┐   ┌──────────────────────┐              │
...
## Coverage Ratios — Why This Matters
...
## 3 Ways Gems Help the Bond Facility

### Strategy 1: Standalone Gem Facility

```
    BONDS → Route 1 (Bond ABL, $4M–$200M)
    GEMS  → Route 3 (Gem-Backed, $12M–$172M)

    Two separate facilities, two separate lender groups.
    No conflict. Each stands on its own merit.
    Combined capacity: up to $372M.
```
...
```
    ...
    This is the fastest way to get capital moving.
```
...
║  asset classes and multiple funding routes. We're choosing YOU        ║
║  because bond ABL is the most efficient path for the notes.           ║
║                                                                        ║
║  FOR GEM LENDERS:                                                      ║
║                                                                        ║
...
║   borrower with a diversified collateral base."                       ║
║                                                                        ║
║  This tells the gem lender: we're not a pawn shop customer.           ║
║  We're a professional SPV with serious assets.                        ║
║                                                                        ║
╚══════════════════════════════════════════════════════════════════════════╝
```
...
```
    NOW:        Deploy Alexandrite ($42M) — already appraised, GO.
    PARALLEL:   Continue Wave 1 bond ABL (14 lenders, in flight).
